...
char* additive_expr(string type1,string type2,char op){
	...
	else if(is_Intgr(type1)||is_float(type1)||is_Intgr(type2)||is_float(type2)){
		if(type1==convert_to_string("_Complex")||type2==convert_to_string("_Complex")){ a="_Complex"; return a;}
		if(type1==convert_to_string("_Imaginary")||type2==convert_to_string("_Imaginary")){ a="_Imaginary"; return a;}
	}
        if(type1==convert_to_string("_Complex")&&type2==convert_to_string("_Complex")) {
		a="_Complex";return a;
	}
        else if(type1==convert_to_string("_Imaginary")&&type2==convert_to_string("_Imaginary")){
		a="_Imaginary";return a;
	}
	else if(type1==convert_to_string("_Imaginary")&&type2==convert_to_string("_Complex")) {
		a="_Complex";return a;
	}
	else if(type1==convert_to_string("_Complex")&&type2==convert_to_string("_Imaginary")) {
		a="_Complex";return a;
	}
...
//    if(type=="long long") return true;
//    if(type=="long int") return true;
//    if(type=="long long int") return true;
//    if(type=="unsigned int") return true;
//    if(type=="unsigned long") return true;
//    if(type=="unsigned long long") return true;
//    if(type=="unsigned long int") return true;
//    if(type=="unsigned long long int") return true;
//    if(type=="signed int") return true;
//    if(type=="signed long") return true;
//    if(type=="signed long long") return true;
//    if(type=="signed long int") return true;
//    if(type=="signed long long int") return true;
//    if(type=="short") return true;
//    if(type=="short int") return true;
//    if(type=="signed short") return true;
//    if(type=="unsigned short") return true;
//    if(type=="unsigned short int") return true;
//    if(type=="signed short int") return true;
//    return false;
// }
...
//    if(type=="unsigned float") return true;
//    if(type=="unsigned double") return true;
//    if(type=="unsigned long double") return true;
//    if(type=="signed float") return true;
//    if(type=="signed double") return true;
//    if(type=="signed long double") return true;
...
// char* unary_expr(string op, string type, int Number){
//     char* a= new char();
//     cout<<"HHHHHHHHEEEEEEEEEEELLLLLLLLLLOOOOOOOOOO\n";
//     if(Number==1){ //unary_operator cast_expression
// 	    if (op=="&"){
//             cout<<"######"<<type<<"##########\n";
// 		    type = type+"*";
...
// 	     }
// 	    if (op=="+"){
// 		if(is_float(type) || is_Intgr(type)|| type=="_Complex"|| type=="_Imaginary" ){;}
// 		else return NULL;
// 	     }
// 	    if (op=="-"){
// 		if(is_float(type) || is_Intgr(type)|| type=="_Complex"|| type=="_Imaginary" ){;}
...
//       a="warning";return a;
//    }
//     if(type1=="char")  type1="long long";
//     if(is_Intgr(type1))   type1="long double";
//     if(type2=="char")  type2="long long";
//     if(is_Intgr(type2))   type2="long double";
    
//    if(is_float(type1) && is_float(type2)){ a = "true";return a; } 
//    if(type1=="void*" && (type2[type2.size()-1]=='*')){
//       a="true";return a;
//    }
//    if(type2=="void*" && (type1[type1.size()-1]=='*')){
//       a="true";return a;
//    }
//    if(type1==type2){
//      a="true";return a;
...
// 	}
// 	else if(is_Intgr(type1)||is_float(type1)||is_Intgr(type2)||is_float(type2)){
// 		if(type1=="_Complex"||type2=="_Complex"){ a="_Complex"; return a;}
// 		if(type1=="_Imaginary"||type2=="_Imaginary"){ a="_Imaginary"; return a;}
// 	}
//         if(type1=="_Complex"&&type2=="_Complex") {
// 		a="_Complex";return a;
// 	}
//         else if(type1=="_Imaginary"&&type2=="_Imaginary"){
// 		a="_Imaginary";return a;
// 	}
// 	else if(type1=="_Imaginary"&&type2=="_Complex") {
// 		a="_Complex";return a;
// 	}
// 	else if(type1=="_Complex"&&type2=="_Imaginary") {
// 		a="_Complex";return a;
// 	}
// 	else if(type1=="char"&&is_Intgr(type2)) {
// 		a="char";return a;
// 	}
//         else if(type2=="char" && is_Intgr(type1)){
//                a="char";return a;
//         }
//         else if((type1[type1.size()-1]=='*')&&is_Intgr(type2)){
//             strcpy(a,type1.c_str());
...
//          else if(type2[type2.size()-1]=='*')
//          {
//              if(is_Intgr(type1)||(type1=="char")){ a = "Bool"; 
//                         return a; }
//              else return NULL;
//          }
//      }
//      if(type1[type1.size()-1]=='*')
//        {
//              if(is_Intgr(type2)||(type2=="char")){ a = "Bool"; 
//                   return a; }
//              else return NULL;
...
//           a="true";return a;
//       }
//       if(is_Intgr(type1) || type1=="bool"){
//             if(is_Intgr(type2) || type2=="bool"){
//                 a="True"; return a;
//             }               
//       } 
//       return NULL;
